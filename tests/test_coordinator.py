...
# Test data
MOCK_CONFIG = {"email": "test@example.com", "password": "password123"}
...
async def test_coordinator_update_success(
    hass: HomeAssistant, mock_config_entry: ConfigEntry, mock_api
):
...
@pytest.mark.asyncio
async def test_coordinator_update_generic_exception(
    hass: HomeAssistant, mock_config_entry: ConfigEntry, mock_api
):
...
@pytest.mark.asyncio
async def test_coordinator_get_data_failure(
    hass: HomeAssistant, mock_config_entry: ConfigEntry, mock_api
):
...
@pytest.mark.asyncio
async def test_coordinator_empty_devices_list(
    hass: HomeAssistant, mock_config_entry: ConfigEntry, mock_api
):
